 ...
 * $HASH(3422b5859905ee16a019a86ebae82a28)
 */
public class CaseMaster extends java.lang.Object implements java.io.Serializable {
    ...
    private java.lang.Boolean priceFoundInd;
    ...
    public CaseMaster(com.miraca.eboss.demo.WeatherInfo weatherInfo, com.miraca.eboss.demo.CaseSource caseSource, com.miraca.eboss.demo.Demographic caseDemographic, java.util.List<com.miraca.eboss.demo.ChargeLine> chargeLine, java.lang.Boolean priceFoundInd) {
    ...
    public java.lang.Boolean getPriceFoundInd() {
        return this.priceFoundInd;
    }

    public void setPriceFoundInd(java.lang.Boolean priceFoundInd) {
        this.priceFoundInd = priceFoundInd;
    }
